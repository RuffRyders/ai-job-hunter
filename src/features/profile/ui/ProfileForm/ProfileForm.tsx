...
import { NEXT_PUBLIC_SUPABASE_URL } from '@/common/data/config/appConfig'
...
export function ProfileForm({
  ...
  const onSubmit: SubmitHandler<ProfileModel> = async (data) => {
    ...
    try {
      if (avatarFile) {
        ...
        if (imageData) {
          data.avatarUrl = `${NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/avatars/${imageData.path}`
        }
      }
  ...
  return (
    <form className="flex flex-col gap-2" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col flex-1 gap-10 max-w-[500px] m-auto pb-[150px]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-2 items-center">
            <Avatar
              size="xl"
              avatarUrl={avatarPreviewUrl || values.avatarUrl}
            />
            <FileTrigger
